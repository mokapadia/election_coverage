# api to interact with News Dataset
...
class NewsApi:
    ...
    def sources(self):
    """ find the unique sources within the data """
        res = list(self.collection.find({ }, {"_id": 0, "source.name":1}))
        return set([i["source"]["name"] for i in res])
